...
| `MEDIA_LENS_JEV_SHADOW_NARROW_ESTIMATED_USD_PER_CALL` | approved operating state is unset, which keeps real narrow calls at zero; do not invent a TypeSafe unit price; a later live call needs a separate owner authorization |
