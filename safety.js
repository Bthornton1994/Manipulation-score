...
const IMMEDIATE_RULES = [
  ...
  },
  {
    id: 'direct_violence',
    pattern:
      /\b(?:(?:i will|i'll)|(?:i'?m|i am)\s+going\s+to)\s+bury\s+you(?:\s+alive)?\b(?!\s+in\b)/gi
  },
  {
    id: 'direct_violence',
    pattern:
      /\b(?:(?:i will|i'll)|(?:i'?m|i am)\s+going\s+to)\s+crush\s+your\s+(?:skull|head)\b/gi
  },
  {
    id: 'direct_violence',
    pattern:
      /\b(?:(?:i will|i'll)|(?:i'?m|i am)\s+going\s+to)\s+blow\s+your\s+brains\s+out\b/gi
  },
  {
    id: 'direct_violence',
    pattern:
      /\b(?:(?:i will|i'll)|(?:i'?m|i am)\s+going\s+to)\s+put\s+a\s+bullet\s+in\s+(?:you|your\s+(?:head|chest))\b/gi
  },
  {
    id: 'direct_violence',
    pattern:
      /\b(?:(?:i will|i'll)|(?:i'?m|i am)\s+going\s+to)\s+put\s+you\s+(?:in\s+the\s+ground|six\s+feet\s+under)\b/gi
  },
  {
    id: 'direct_violence',
    pattern:
      /\b(?:(?:i will|i'll)|(?:i'?m|i am)\s+going\s+to)\s+skin\s+you\s+alive\b/gi
  },
  {
    id: 'direct_violence',
  ...
  },
  {
    id: 'direct_violence',
    pattern:
      /\b(?:i'?m|i am|im)\s+going\s+to\s+(?:kill|hurt|harm|shoot|stab|murder|torture|gut)\s+you\b/gi
  },
  {
    id: 'direct_violence',
    pattern: /\b(?:i will|i'll)\s+(?:kill|hurt|harm|shoot|stab|murder|torture|gut)\s+you\b/gi
  },
  {
    id: 'direct_violence',
...
function extractHarmVerb(matchText) {
  const verb = matchText.match(
    /\b(kill|hurt|harm|murder|shoot|stab|torture|gut|bury|skin)\b/i
  );
...
function isInstructionalQuote(clauseText, matchStart) {
  ...
  if (
    ...
    const firstPersonBefore =
      /\b(?:i'?m|i am|i will|i'?ll)\s+(?:going\s+to|will)\s+(?:kill|hurt|harm|shoot|stab|torture|gut|bury|skin)/i.test(
...
function isTrainingOnlyClause(clauseText) {
  ...
  const firstPersonThreat =
    /\b(?:i'?m|i am|i will|i'?ll)\s+(?:going\s+to|will)\s+(?:kill|hurt|harm|shoot|stab|murder|torture|gut)\s+you\b/i.test(
      clauseText
    );
...
function isFirstPersonThreatMatch(clauseText, matchStart, matchText) {
  ...
  return /\b(?:i\s+will|i'll|i'?ll|i'?m|i am)\s+(?:going\s+to\s+)?(?:kill|hurt|harm|shoot|stab|murder|torture|gut|bury|skin)\b/i.test(
    window
  );
}
